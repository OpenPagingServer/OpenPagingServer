...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO messages (messageid, name, type, shortmessage, longmessage, color, audio) VALUES (:id, :name, :type, :shortmessage, :longmessage, :color, :audio)");
    $stmt->execute([
        'id' => $newId,
        'name' => $name,
        'type' => $type,
        ...
        <form method="POST">
            ...
            <div id="visual-fields" style="display:none;">
                ...
                <div class="form-group">
                    ...
                    <textarea name="longmessage" id="longmessage" class="form-control" rows="5"></textarea>
                </div>
