...
def frame_response(title, body, active="endpoints", user=None, status=200):
    return Response(
        f"""<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>{h(title)}</title><link rel="stylesheet" href="/assets/theme.css"></head>
<body>{body}<script>
(function() {{
  function sendHeight() {{
...
def chooser_response(module, forms):
    ...
    return Response(
        f"""<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><style>{style}</style><link rel="stylesheet" href="/assets/theme.css"></head><body>{body}<script>
(function() {{
  function sendHeight() {{
...
def endpoint_frame_success_redirect(message):
    ...
    return Response(
        f"""<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><title>Endpoint saved</title><link rel="stylesheet" href="/assets/theme.css"></head>
<body>
<script>
